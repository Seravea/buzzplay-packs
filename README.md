...
Catalogue **public** des packs de quiz BuzzPlay. L'app le télécharge **automatiquement à chaque lancement** (silencieux, avec cache hors-ligne) : **modifier ce fichier suffit**, aucune mise à jour de l'app n'est nécessaire.
